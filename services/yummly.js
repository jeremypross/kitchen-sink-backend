...
// returns first 20 search results
Yummly.getRecipes = (search) => {
  console.log("search term:", search)
  return fetch(`http://api.yummly.com/v1/api/recipes?_app_id=${APP_ID}&_app_key=${APP_KEY}&q=${search}&maxResult=30&start=0&requirePictures=true`);
}
